...
def transcribe_streaming_voice_activity_timeouts(project_id, recognizer_id, audio_file):
    ...
    for response in responses_iterator:
        ...
        if response.speech_event_type == cloud_speech.StreamingRecognizeResponse.speech_event_type.SPEECH_ACTIVITY_BEGIN:
          print("Speech started.")
        if response.speech_event_type == cloud_speech.StreamingRecognizeResponse.speech_event_type.SPEECH_ACTIVITY_END:
          print("Speech ended.")
